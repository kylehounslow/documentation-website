...
function openPlayground(button) {
    ...
    const qParam = `(dataset:(dataSource:(id:'11c38c30-c3f4-11f0-85c9-87c2e8e28815',title:dataSource,type:data-source),id:a7ab3950-c8a9-11f0-85c9-87c2e8e28815,timeFieldName:observedTimestamp,title:'otel-demo-logs*',type:INDEX_PATTERN),language:PPL,query:'${encodedQuery}')`;
